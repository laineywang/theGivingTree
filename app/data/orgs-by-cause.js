const orgs_by_cause = {
    ...
    "Current": [
     ...
     "url": "https://eng.ffr.org.ua/support-in-crisis/eng"}, 
      ...
      { "id": 6, "cause": "Current","name": "PFM", "description": "Support the integration of people who migrate to Poland.", "logo": require("../assets/images/logos/PFM.png"),
     ...
     "url": "https://forummigracyjne.org/"}, 
      ...
      { "id": 7, "cause": "Current","name": "Urgent Action Fund", "description": "Support women’s human rights defenders striving to create cultures of justice, equality and peace..", "logo": require("../assets/images/logos/UAFWHR.png"),
     ...
     "url": "https://eng.ffr.org.ua/support-in-crisis/eng"}, 
      ...
      { "id": 8, "cause": "Current","name": "IOM", "description": "Donate today to help us provide emergency support to vulnerable people on the move.", "logo": require("../assets/images/logos/IOM.png"),
  ...
  "Disease" : [
      { "id": 9, "cause": "Disease","name": "American Cancer Society’s", "description": "save lives, celebrate lives, and lead the fight for a world without cancer.", "logo": require("../assets/images/logos/AmericanCancerSociety.png"),
     ...
     "url": "https://www.cancer.org/"}, 
      ...
      { "id": 10, "cause": "Disease","name": "National Alliance on Mental Illness", "description": "All individuals and families affected by mental illness can build better lives.", "logo": require("../assets/images/logos/NationalAllianceonMentalHealth.png"),
     ...
     "url":"https://www.lls.org/"}, 
      ...
      { "id": 12, "cause": "Disease","name": "St. Jude Children’s Research Hospital", "description": "No child should die on the dawn of their life.", "logo": require("../assets/images/logos/St.JudeChildren'sResearchHospital.png"),
     "info": "Fight For Right works to let all Ukrainians with disabilities know the answer to this question. Our team has a clear position: #IStayInUkraine and we do everything to make it safe for Ukrainians with disabilities to stay here.",
  ...
  "Education" : [
      { "id": 21, "cause": "Education","name": "Scholarship America", "description": "We Have One Passion. Every Student.", "logo": require("../assets/images/logos/ScholarshipAmerica.png"),
     "info": "Our goal is to create a world where equity is central; where respect and inclusion are the cornerstones of our culture; where every student can access opportunities to learn, grow, succeed and thrive.", "url": "https://scholarshipamerica.org/"},    
      ...
      { "id": 22, "cause": "Education","name": "ProLiteracy", "description": "Empowering adults through literacy", "logo": require("../assets/images/logos/ProLiteracy.jpg"),
     "info": "Our vision is to be the leading resource and champion for adult education and literacy worldwide. ProLiteracy commits to making diversity, equity, inclusion, and anti-racism a priority in our organization.", "url": "https://www.proliteracy.org/"},     
      ...
      { "id": 23, "cause": "Education","name": "Build Africa", "description": "Working for a better future.", "logo": require("../assets/images/logos/BuildAfrica.jpg"),
     "info": "In 2019, Build Africa merged with Street Child so that together we can help more children get the education they deserve. Street Child believes that achieving universal basic education is the single greatest step that can be taken towards the elimination of global poverty.", "url": "https://www.build-africa.org/"},
      ...
      { "id": 24, "cause": "Education","name": "Children International", "description": "Bringing people together to end poverty for good.", "logo": require("../assets/images/logos/ChildrenInternational.png"),
  ...
  "Hunger Relief": [
      { "id": 26, "cause": "Hunger Relief","name": "Second Harvest of Silicon Valley", "description": "No one should ever go hungry.", "logo": require("../assets/images/logos/SecondHarvestFoodBankofSiliconValley.jpg"),
  ...
  { "id": 27, "cause": "Hunger Relief","name": "California Association of Food Banks", "description": "We lead the collective effort to end hunger in California.", "logo": require("../assets/images/logos/CaliforniaAssociationofFoodBanks.png"),
